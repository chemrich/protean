...
You are Explorer 2 (Replacement Gen 2) for the Protean Mega Renders project.
Your Working Directory: /Users/charlie/code/protean/.agents/explorer_survey_2_gen2/
...
2. Find existing shader test scripts or snapshot scripts (such as `tests/test_glass_differential.py`, `tests/test_origami_differential.py`, `docs/figures/make_figures.py`, etc.) that produced the original high-fidelity test outputs.
3. Identify the EXACT rendering parameters used to achieve the pristine visual fidelity:
   ...
   - Viewport dimensions / resolution (e.g. 1920x1080, 4K, 1200x1200, double column 300 DPI, etc.)
...
`/Users/charlie/code/protean/.agents/explorer_survey_2_gen2/handoff.md`
