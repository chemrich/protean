// GENERATED by make_candidates.py -- do not hand-edit.
//
...
bool isOutsideBounds(const in vec2 coords) {
    ...
    return any(bvec4(lessThan(coords, uBounds.xy), greaterThan(coords, uBounds.zw)));
}
    ...
    float occlusion = 0.0;
        ...
        for(int l = 0; l < dLevels; l++) {
            ...
            for(int i = 0; i < dNSamples; i++) {
                ...
                float inBounds = isOutsideBounds(offset.xy) ? 0.0 : 1.0;
                nSamples -= 1.0 - inBounds;
                offset.xy = clamp(offset.xy, uBounds.xy, uBounds.zw);
