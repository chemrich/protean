...
//
// Mol* 5.6.0's ssao.frag, with the isBackground predicate replaced by the
// repair protean ships in viewer/src/molstar-patches.ts, and nothing else
// changed. Measured through --shader-swap ssao.frag=@<this file> so that the
// cost of ssao.frag's body can be read in the regime protean actually runs in,
