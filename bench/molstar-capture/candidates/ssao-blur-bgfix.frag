// GENERATED by bench/molstar-capture/make_candidates.py -- do not hand-edit.
//
// Mol* 5.6.0's ssao-blur.frag, with the isBackground predicate replaced by the
// repair protean ships in viewer/src/molstar-patches.ts, and nothing else
// changed. Measured through --shader-swap ssao-blur.frag=@<this file> so that the
// cost of ssao-blur.frag's body can be read in the regime protean actually runs in,
